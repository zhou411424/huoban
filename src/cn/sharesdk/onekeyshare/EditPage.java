...
//		}
		...
		llTitle.getChildAt(3).setVisibility(View.INVISIBLE);
		
		LogUtil.logE("llTitleChild:"+llTitle.getChildCount());
		
		llTitle.getBtnBack().setImageResource(R.drawable.red_backo);
		llTitle.getBtnBack().setOnClickListener(this);
		int resId = getStringRes(activity, "multi_share");
		if (resId > 0) {
			llTitle.getTvTitle().setTextColor(0xff000000);
		...
		if (resId > 0) {
			...
			llTitle.getBtnRight().setTextColor(0xff000000);
		}
