...
public class ContactAddActivity extends BaseActivity implements OnClickListener {

	private final static String TAG = "ContactAddActivity";
	...
	public void onClick(View v) {
		...
		case R.id.contacts_add_contacts:
			mIntent.setClass(this, ContactsContactActivity.class);
			startActivity(mIntent);
			break;
		case R.id.contacts_add_shaomiao:
			mIntent.setClass(this, CaptureActivity.class);
			startActivity(mIntent);
			break;
		}
	}
